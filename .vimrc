...
Plug 'neoclide/coc-tslint', {'do': 'npm install --frozen-lockfile'}
Plug 'neoclide/coc-css', {'do': 'npm install --frozen-lockfile'}
Plug 'neoclide/coc-lists', {'do': 'npm install --frozen-lockfile'} " mru and stuff
Plug 'neoclide/coc-highlight', {'do': 'npm install --frozen-lockfile'} " color highlighting
